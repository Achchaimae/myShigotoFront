<template>
    <main>
        <div class="bg-white bg-opacity-20 w-full h-20 flex items-center my-4">
            <div class="flex items-center justify-around  w-full">
                <img src="@/assets/images/Meta.png" class="w-24 " alt="">
                <img src="@/assets/images/Google.png" class="w-24 " alt="">
                <img src="@/assets/images/Oracle.png" class="w-24 " alt="">
                <img src="@/assets/images/Microsoft.png" class="w-24 " alt="">
            </div>
...
<footer aria-label="Site Footer" >
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-start lg:gap-8">
      <!-- <div class="text-teal-600 dark:text-[#531CB3]">
        <svg
          class="h-8"
          viewBox="0 0 28 24"
          fill="none"
        ...
        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form class="w-full">
            ...
            >
              ...
              <button
                class="mt-1 w-full bg-[#531CB3] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none border-2  hover:bg-[#111] hover:border-2 border-[#531CB3] rounded sm:mt-0 sm:w-auto sm:flex-shrink-0"
              >
                Sign Up
              </button>
            </div>
