          ...
          <table class="table-auto min-w-max w-full">
            ...
            <tbody class="text-gray-600 text-sm font-light text-center">
              <tr class="border-b border-gray-200 hover:bg-gray-100">
                <td class="hidden sm:table-cell py-3 px-6 text-left whitespace-nowrap">WEB Dev</td>
                <td class="hidden sm:table-cell py-3 px-6 text-left whitespace-nowrap">File</td>
                <td class="py-3 px-6 text-left whitespace-nowrap">achchaimae1@gmail.com</td>
                <td class="py-3 px-6 text-left whitespace-nowrap">0682751559</td>
