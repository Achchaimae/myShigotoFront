<template>
    <main>
       ...
       <section class="flex flex-wrap " >
            <div  class="bg-white rounded-lg w-[70%] h-[85vh] m-4">
                <div v-if="!conversationStore().Loading" class="flex m-6 space-x-4 h-[90vh]">
            <div class="w-1/3 h-[80vh] bg-white p-[2px] rounded-lg">
            ...
            <div class="w-full h-[80vh] bg-white rounded-lg p-2">
                ...
                <div class="h-[76%] overflow-y-auto m-2 relative">
                    <div v-for="conversationMessage in conversationStore().messages.messages" :key="conversationMessage">
                        <div v-if="conversationMessage.user_id == id"
                ...
                <div>
                    <div class="w-full">
                        <div class="bg-[#F4F5F8] p-2 flex m-2 rounded-lg">
                            ...
                            <button
                                @click="conversationStore().sendMessage(conversationStore().messages.id, id, token, message)"
                                class="bg-[#9191E9] text-white p-2 rounded-lg left-4 "><svg
        ...
        <div v-else>
            ...
            <div class="mx-auto flex flex-col">
                <div class="m-auto">
                    <img src="@/assets/images/messagefooter.png" alt="">
                </div>
                <div>
                    <div class="max-w-2xl mx-auto text-white py-10">
                        <div class="text-center">
                            <h3 class="text-3xl mb-3"> Download our app </h3>
                            <p> Get your dream job easily with just your gadget . </p>
                        ...
                        <div class="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
                            <p class="order-2 md:order-1 mt-8 md:mt-0"> &copy; myShigoto , 2023. </p>
...
// onBeforeMount(() => {
//     conversationStore().getConversations(localStorage.getItem("id"), localStorage.getItem("token"));
// });
onBeforeMount(async () => {
    console.log("before mount");
    await conversationStore().getConversations(localStorage.getItem("id"), localStorage.getItem("token"));
});
